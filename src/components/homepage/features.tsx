  ...
  features = [
    {
      title: "Performance",
      description:
        "Track your website's response time, uptime, and performance metrics in real-time.",
      icon: <Timer className="size-4 md:size-6" />,
    },
    {
      title: "Innovation",
      description: "Stay ahead of the curve with our cutting-edge solutions and features.",
